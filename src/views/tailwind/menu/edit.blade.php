...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <h4 class="text-xl font-bold text-gray-900 dark:text-gray-100">Edit Menu</h4>
    ...
    @if (Route::has('useraccess.menu.update'))
        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm p-6">
            <form action="{{ route('useraccess.menu.update', $moduleAction->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="text" name="name" id="name" class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('name') border-red-500 @enderror" placeholder="Name" value="{{ old('name', $moduleAction->name) }}" >
                        @error('name')
                    ...
                    <div>
                        ...
                        <input type="text" name="prefix" id="prefix" class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('prefix') border-red-500 @enderror" placeholder="Prefix" value="{{ $prefix[0] }}">
                        @error('prefix')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="action" id="action" class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('action') border-red-500 @enderror" placeholder="Web Url" value="{{ old('action', $moduleAction->action) }}" >
                        <p id="final_url" class="text-xs text-gray-500 mt-1">Final URL is : {{ $prefix[0] }}{{ old('action', $moduleAction->action) }}</p>
                        @error('action')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="route_name" id="route_name" class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('route_name') border-red-500 @enderror" placeholder="Route name" value="{{ $route_name[0] }}">
                        @error('route_name')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="menu_label" id="menu_label" class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('menu_label') border-red-500 @enderror" placeholder="Admin Menu Label" value="{{ old('menu_label', $moduleAction->menu_label) }}">
                        @error('menu_label')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="menu_order" id="menu_order" class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('menu_order') border-red-500 @enderror"  placeholder="Sub-menu Order" value="{{ old('menu_order',$moduleAction->menu_order) }}">
                        @error('menu_order')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="menu_icon" id="menu_icon" class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('menu_icon') border-red-500 @enderror"  placeholder="Menu Icon" value="{{ old('menu_icon', $moduleAction->menu_icon) }}">
                        @error('menu_icon')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="module_label" id="module_label" class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('module_label') border-red-500 @enderror"  placeholder="Module Label" value="{{ old('module_label', $moduleAction->module_label) }}">
                        @error('module_label')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <input class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 @error('extra_options') border-red-500 @enderror" type="checkbox" value="auth" name="extra_options[]" id="auth" {{ in_array("auth", $filters) ? 'checked="checked"' : '' }}>
    ...
    @else
        <div class="p-4 bg-red-100 border border-red-400 text-red-700 rounded-md text-sm" role="alert">You do not have permission to edit a menu.</div>
    @endif
</div>
@endsection
